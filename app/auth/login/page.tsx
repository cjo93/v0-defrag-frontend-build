    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md border border-white/12 p-8">
          <h1 className="text-3xl font-serif mb-2">Access Portal</h1>
          <p className="font-sans text-white/60 text-sm mb-8">Authenticate to enter the system.</p>
          ...
          <div className="mt-6 text-center text-xs font-sans text-white/60">
            No active profile? <Link href="/auth/signup" className="text-white hover:underline">Request initialization</Link>
          </div>
        </div>
      </main>
    </div>
