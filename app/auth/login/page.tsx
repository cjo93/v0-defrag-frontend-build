    ...
    <div className="min-h-screen bg-black text-white font-sans antialiased flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-[400px] space-y-8 relative">
        <div className="space-y-2">
          ...
          <h1 className="text-[28px] font-medium tracking-[-0.02em]">Access your account</h1>
        </div>
        ...
        {appleEnabled && (
          <>
            <button
              ...
              className="w-full h-12 border border-white/[0.08] hover:border-white/20 transition-colors duration-200 font-mono text-[13px] uppercase tracking-[0.08em] flex items-center justify-center gap-3"
            >
              Continue with Apple
            </button>
            <div className="flex items-center gap-4">
              <div className="flex-1 h-px bg-white/[0.06]" />
              <span className="font-mono text-[11px] uppercase tracking-[0.12em] text-white/30">Or email</span>
              <div className="flex-1 h-px bg-white/[0.06]" />
            </div>
          </>
        )}
